...
// function addAnotherExercise (e){
//     e.preventDefault()
//     document.getElementById('add-exercise-block').insertAdjacentHTML("afterend",
//         '<div class="exercise">\n' +
//             '        <h2 id="another-name"></h2>\n' +
//             '        <div id="add-another-set"></div>\n' +
//             '        <button id="add-another-btn" onclick="addAnotherSet()">Add Set</button>\n ' +
//             '</div>'
//         )
//     document.getElementById('another-name').innerHTML = e.target.id
//     console.log('addAnotherExercise')
// }
//
// function addAnotherSet(){
//     document.getElementById('add-another-set').insertAdjacentHTML("beforeend",
//         '<div id="add-set-set">\n' +
//         '            <div id="set-set">\n' +
//         '               <div>set:</div>\n' +
//         '               <p id="set-set-count">'+setNum+'</p>\n'+
